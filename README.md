...
>- [こちら](115-1000_Display)の115系1000番台向け表示灯拡張基板を製作し接続すると、メーターパネルの表示灯(一部)も連動可能に。こちらを利用すると、気合と根性で圧力計やATS-P機器などとも連動できるようになるかもしれません。
...
> [!TIP]
>- Serial1出力と5V出力は、[表示灯類](115-1000_Display)、[圧力制御](GraphTechKEN/Densei)など拡張用のために用います。
...
## BVEとの連動方法
> [こちら](SerialOutputEx)のSerialOutputExを参照してください。
